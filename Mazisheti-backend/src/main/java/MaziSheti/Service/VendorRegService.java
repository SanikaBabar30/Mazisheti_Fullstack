...
public class VendorRegService {
    ...
    /**
     * Register new vendor with validation and password hashing
     */
     ...
     * Get vendor by Email
     */
    public VendorReg getVendorByEmail(String email) {
        Optional<VendorReg> vendorOpt = vendorRepository.findByEmail(email);
        return vendorOpt.orElse(null);
    }
    ...
    /**
     * Validate mobile number: 10 digits, does not start with 0
     */
